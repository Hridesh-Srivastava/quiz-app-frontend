...
export default function AboutUs() {
  ...
  return (
    <div className="about-us-container">
      <button className="about-us-toggle" onClick={() => setIsOpen(!isOpen)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <div className={`about-us-content ${isOpen ? "visible" : ""}`}>
        <h3 className="about-us-title">HSST TechQuiz Hub</h3>
        <p className="about-us-description">
          The HSST Quiz Hub is an initiative by the Creative Cell Bootcamp of Himalayan School of Science and
          Technology, Swami Rama Himalayan University. Our platform is designed to enhance learning through interactive
          assessments that challenge students' understanding of various technical subjects.
        </p>

        <h4 className="about-us-features-title">Key Features:</h4>
        <ul className="about-us-features">
          <li className="about-us-feature-item">User-friendly interface designed by HSST students</li>
          <li className="about-us-feature-item">Secure registration system to track your academic progress</li>
          <li className="about-us-feature-item">Immediate feedback on your performance</li>
          <li className="about-us-feature-item">
            Comprehensive result analysis to help identify areas for improvement
          </li>
        </ul>

        <div className="about-us-footer">
          <p>© 2025 Himalayan School of Science and Technology, SRHU</p>
          <p>
            Developed by Creative Cell Bootcamp
            <br />
            For any inquiries, please contact <a href="mailto:principal.hsst@srhu.edu.in">principal.hsst@srhu.edu.in</a>
          </p>
        </div>

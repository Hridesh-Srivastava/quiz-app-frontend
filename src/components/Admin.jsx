...
export default function Admin() {
  ...
  return (
    <div className="container admin-container">
      <h1 className="title">SST Quiz Admin Dashboard</h1>

      <div className="admin-card">
        <div className="admin-header">
          <h2 className="admin-title">SST Quiz Management</h2>
          <p className="admin-subtitle">Manage SST TechQuiz questions and student data</p>
        </div>
